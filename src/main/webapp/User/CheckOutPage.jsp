    ...
    <body>
        <div id="popup" class="form-container">
            <div class="con">
                ...
                <a href="IndexController"><button class="btn2" onclick="closeForm()" class="buttonTable">Continue Shopping</button></a>
                <button class="btn2" onclick="closeForm()" class="buttonTable">View Order</button>
