...
<html>
    ...
    <body>
        <div class="nav">
            <!--top left welcome-->
            <h3 class="logo" style=" color: white; margin-left: 100px; bold">Welcome</h3>
            <!--header list top right-->
            <ul>
                <li><a  href="IndexController" ><button class="btn">Home</button></a></li>
                <li><button  class="btn" onclick="document.getElementById('cartModal').style.display = 'block'">Cart <span class="badge badge-danger">${cart_list.size()}</span></button></li>
                ...
                <li><a href="UserController?action=editForm" class="btn">Profile</a></li>
                ...
                <li><a  href="LoginController?action=logout" class="btn">Logout</a></li>
                    ...
                    %>
                <li><a href="OrderReportController?action=get"<%= user.getUserID()%>" class="btn">Manage</a></li>
                <li><a  href="LoginController?action=logout"  class="btn">Logout</a></li>
                    <%}
                        }%> 
                                                ...
                                                <div class="card-body">
                                                    <div class="d-flex justify-content-between">
                                                        ...
                                                        <div class="d-flex flex-row align-items-center">
                                                            ...
                                                            <!--name of list-->
                                                            <div class="ms-3" style="padding-left: 15px; padding-top: 15px; margin-left: 50px; width: 100px;">
                                                                <h5><%=p.getName()%></h5>
                                                        ...
                                                        <div class="d-flex flex-row align-items-center">
                                                            ...
                                                            <div style="width: 80px;">
                                                                <label>Price:</label>
                                                                <h5 id="price_<%=p.getProductID()%>" class="mb-0">R<%=p.getPrice() * p.getQuantity()%></h5>
                                                            </div>
                                            ...
                                            <div class="card bg-info text-white rounded-3">
                                                <div class="card-body">
                                                    ...
                                                    <div class="d-flex justify-content-between mb-4">
                                                        ...
                                                        <p class="mb-2">R<span id="totalPrice"><%=totalPrice > 0 ? dcf.format(totalPrice) : 0%></span></p>
                                                    </div>

                                                    <!--button to pay now-->
                                                    <button type="button" class="btn btn-info btn-block btn-lg"><a href="ChekOutController?action=getA">
                                                            <div class="d-flex justify-content-between">
                                                                <span>R<span id="payNowPrice"><%=totalPrice%></span></span>
                                                                <span>Pay Now <i class="fas fa-long-arrow-alt-right ms-2"></i></span>
                                                            </div></a>
                                                    </button>
                                                    <%
                                                        }
