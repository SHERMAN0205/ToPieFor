...
<html>
    <head>
        ...
        <link href="AdminCSS/CategoryPageCSS.css" type="text/css" rel="stylesheet" />
        <script src="AdminJS/CategoryPageJS.js"></script>
    ...
    <section class="page-content">
        ...
        <%-- -------------------------------------------------------------------------------------------------------------------------------------------- --%>
        <!--Add category button and text field-->
        <div class="topnav" style="">
            <h2><p>Add a category to the List of Categories </p></h2>
            <br>
            <form method="POST"action="CategoryController">
                <input type="hidden" name="action" value="add" >
                <label for="fname"><b>Category name:</b></label>
                <br>
                <span><input  name="categoryName" type="text" class="input" required=""></span>
                <br>
                <span><input type="submit" class="buttonTable" ></span>
            </form>
        </div>
        <br>
        <!--=================popup=====================-->
        ...
        <div class="topnavMain" style="">
            <h2>All Categories in the database</h2>
            <br>
            ...
            <table style="width:75%; margin: 0 auto;" id="myTable">
                ...
                <tr>
                <form name="editForm" action="CategoryController" method="POST">
                    <!-- Category ID Category Name -->
                    <!--   Category Name -->
                    <td>
                        <input id="editable" type="text" name="categoryName" value="<%=category%>" >
                    </td>
                    <!--   Status    -->
                    <td>
                        <p ><%= status%></p>
                ...
                <!-- Delete form -->
                <td>
                    <form name="deleteForm" action="CategoryController" method="POST">
