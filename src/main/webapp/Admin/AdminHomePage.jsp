...
<%@page import="com.topiefor.models.OrderReport"%>
...
<html>
    <head>
        ...
        <link href="AdminCSS/AdminHomePageCSS.css" type="text/css" rel="stylesheet" />
        <script src="AdminJS/AdminHomePageJS.js"></script>
        
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>Admin Page</title>
        <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
        <% ArrayList<OrderReport> orderReportList = (ArrayList<OrderReport>) request.getAttribute("allOrderReports"); %>
        <style>
        ...
        <div class="container">
            ...
            <div >
                <div class="topnavMain" style="">
                    <label style=" text-align: center;"><h2>Total Orders For the Day</h2></label>
                </div>
                <br>
                ...
                <div class="grid-container">
                    ...
                    <%
                        if (orderReportList != null && !orderReportList.isEmpty()) {
                            for (OrderReport or : orderReportList) {

                                int orderReportID = or.getOrderID();
                                String orderCategory = or.getCategory().getName();
                                int totProdOrdered = or.getTotProdOrdered();
                                double totAmountInCart = or.getTotAmntPerCat();
                    %>
                    <div class="grid-item">
                        <div class="card" style="">
                            <div class="card-body">
                                <br>
                                <h4>Category:</h4>
                                <h5 class="card-title"><%= orderCategory%></h5>
                                <br>
                                <h4>Total Products Ordered:</h4>
                                <h5 class="card-title"><%= totProdOrdered%></h5>
                                <br>
                                <h4>Total Amount spent per Category:</h4>
                                <h5 class="card-title">R<%= totAmountInCart%></h5>
                                <br><br>
