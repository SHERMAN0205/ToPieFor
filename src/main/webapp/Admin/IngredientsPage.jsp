    ...
    <section class="page-content">
        ...
        <div class="topnavMain" style="">
            ...
            <table style="width:75%; margin: 0 auto;" id="myTable">
                ...
                <tr>
                <form name="editForm" action="IngredientController" method="GET">

                    <!--Add Form -->
                    <!--   Ingredient Name -->
                    <td>
                        <input id="editable" type="text" name="IngredientName" value="<%=ingredient%>" >
                    </td>
                    <!--   Quantity -->
                    <td>
                        <input id="editable" type="text" name="IngredientQuantity" value="<%=quantity%>" >
                    </td>
                    <!--   Unit Type -->
                    <td>
                        <input id="editable" type="text" name="IngredientUnit" value="<%=unit%>" >
                    </td>
                    <!--   Status    -->
                    <td>
                        <p ><%= status%></p>
