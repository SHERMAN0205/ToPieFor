...
<html>
    <head>
        ...
        <link href="AdminCSS/OrderPageCSS.css" type="text/css" rel="stylesheet" />
        <script src="AdminJS/OrderPageJS.js"></script>
    ...
    <section class="page-content">
        ...
        <div class="topnav" style="">
            <label style=" text-align: center;"><h2>Recipe List Orders</h2></label>
            <br>
                ...
                <%
                    ...
                    if (orderList != null && !orderList.isEmpty()) {
                        for (Order c : orderList) {
                            ...
                            List<Product> prodList = c.getProduct();
                            ...
                            String status = originalStatus.equals("To Be Made") ? "Baked" : "Delivered";
                            if (status.equals("Baked")) {
                %>
                <div class="grid-item">
                    <div class="card" style="">

                        <form name="pdfForm" action="PdfOrderController" method="POST">
                            ...
                            <div class="card-body">
                                <div class="card-body">
                                    ...
                                    <!-- Other content of the card-body -->
                                </div>
                                <br>
                                        ...
                                        <%
                                            if (prodList != null && !prodList.isEmpty()) {
                                                for (Product p : prodList) {
                                                    String prodDetail = p.getRecipe().getRecipeName();
                                        %>
                                <h5 class="card-title"><%= prodDetail%></h5>
                                <%
                                        }
                                    } else {
                            ...
                            <input type="hidden" name="orderInfo" value="<%= orderID + "," + formattedDate + "," + DformattedDate + "," + userTele + "," + originalStatus%>">
                            <button onclick="generatePdf()" class="buttonTable" style="display: inline-block; width: 100px; height:40px;">View Recipe</button>
                        </form>
                        <form name="deleteForm" action="OrderController" method="POST">
                            <div>
