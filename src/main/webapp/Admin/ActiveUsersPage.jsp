...
<html>
    <head>
        ...
        <link href="AdminCSS/ActiveUsersPageCSS.css" type="text/css" rel="stylesheet" />
        <script src="AdminJS/ActiveUserPageJS.js"></script>
        
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>Active Users Page</title>
        <style>
    ...
    <section class="page-content">
        ...
        <div class="topnav" style="display: flex; flex-direction: column; align-items: center;">
            <label style=" text-align: center;"><h2>Active Users - Only</h2></label>
            <br>
            ...
            <div class="grid-container">
                <%
                    ...
                    if (userList != null && !userList.isEmpty()) {
                        for (User user : userList) {
                            ...
                            String telephone = user.getTelephoneNumber();
                ...
                <div class="grid-item">
                    <div class="card" style="">
                        <form name="pdfForm" action="PdfActiveUsersController" method="POST">
                            <div class="card-header">
                                <h1 class="order-heading">User ID: </h1>
                                <h1 class="position-number"><%= userID%></h1>
                            </div>
                            <br>
                            <div class="card-body">
                                <div class="card-body">
                            ...
                            <input type="hidden" name="orderInfo" value="<%= userID + ',' + username + ',' + surname + ',' + role + ',' + telephone%>">
                            <button onclick="generatePdf()" class="buttonTable" style="display: inline-block; width: 100px; height:40px;">View Users</button>
                        </form>
                    </div>
                </div>
                <%
                        ...
                        out.print("<tr><td colspan='4'>No active users found.</td></tr>");
                    }
