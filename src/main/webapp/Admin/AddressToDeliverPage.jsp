...
<html>
    <head>
        ...
        <link href="AdminCSS/AddressToDeliverPageCSS.css" type="text/css" rel="stylesheet" />
        <script src="AdminJS/AddressToDeliverPageJS.js"></script>

        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>Address Delivery Page</title>
        <style>
    ...
    <section class="page-content">
        ...
        <div class="topnav" style="">
            <label style=" text-align: center;"><h2>Address to be Delivered</h2></label>
            <br>
                ...
                <%
                    ...
                    if (orderList != null && !orderList.isEmpty()) {
                        for (Order c : orderList) {
                            ...
                            String status = originalStatus.equals("Baked") ? "Delivered" : "Baked";
                            if (status.equals("Delivered")) {
                %>
                <div class="grid-item">
                    <div class="card" style="">
                        <form name="pdfForm" action="PdfDeliverController" method="POST">
                            ...
                            <div class="card-body">
                                ...
                                <div class="order-details">
                                    <div class="order-detail">
                                        <h4><u>Street:</u></h4>
                                        <h5 class="card-title"><%= userInfo2%></h5>
                                    </div>
                                    <div class="order-detail">
                                        <h4><u>Suburb:</u></h4>
                            ...
                            <button onclick="generatePdf()" class="buttonTable" style="display: inline-block; width: 100px; height:40px;">View Details</button>
                        </form>
                        <form name="deleteForm" action="OrderController" method="POST">
                            <div>
                                <input type="hidden" name="action" value="editBaked">
                                <input type="hidden" name="orderID" value="<%=orderID%>">
                                <input type="hidden" name="status" value="<%=status%>">
                                <span>
                                    <input type="submit" value="<%=status%>" class="buttonTable" id="submit-buttonBaked">
                                </span>
                            </div>
                        </form>
                    </div>
