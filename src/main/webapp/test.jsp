        ...
        <div class="box">
            ...
            <div class="page">
                ...
                <div class="content">
                    ...
                    <!--Login Form-->
                    <form  action="/ToPieFor/LoginController" class="login" name="loginForm" onsubmit="return validateLoginForm()" method="GET" >
                    ...
                    <!--SignUp Form-->
                    <form class="signup" name="signupForm" action="/ToPieFor/UserController" method="GET">
                        <input type="text" name="userName" id="signName" placeholder="Username">
                        <input type="email" name="email" id="signEmail" placeholder="Email">
                        <input type="text" name="telephone" id="telePhoneNumber" placeholder="Telephone Number">
                        <input type="hidden" name="action"  value="addU">
                        <input type="text" name="street" id="STAddress" placeholder="Street Address">
