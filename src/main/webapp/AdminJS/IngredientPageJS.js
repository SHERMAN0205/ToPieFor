...
//sort buttons for Ingredients

function sortTableAlphabeticalIngredient() {
...
//sort buttons for UnitType

function sortTableAlphabeticalUnit() {
    var table, rows, switching, i, x, y, shouldSwitch;
    table = document.getElementById("myTable");
    switching = true;
    /*Make a loop that will continue until
...
function mySearchFunction() {
    ...
    for (i = 1; i < rows.length; i++) {
        ...
        if (cell) {
            var usernameInput = cell.querySelector('input[name="IngredientName"]');
            if (usernameInput) {
...
//search tab  to hid and hide items done in search
