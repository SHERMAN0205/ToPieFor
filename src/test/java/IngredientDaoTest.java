...
//        Ingredient ingredient = new Ingredient(0, "gyunhv", 500,new Unit(1), true);
...
//
//       IngredientDao ingredientDao = IngredientDaoImpl.getInstance(con);
//        Ingredient ingredient = new Ingredient(3, "wheat", 4);
...
//        
//      IngredientDao ingredientDao = IngredientDaoImpl.getInstance(con);
//       Ingredient ingredient = new Ingredient(10, "Suncake now", 4, new Unit(1));
